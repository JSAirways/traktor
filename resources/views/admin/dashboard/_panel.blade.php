{{-- Shared dashboard analytics panel (no layout). Expects $displayUser and $availableUsers. --}}
@php
    $showTitle = $showTitle ?? true;
    $showUserSelector = $showUserSelector ?? true;
    $userSelectorRoute = $userSelectorRoute ?? route('admin.dashboard.index');
@endphp
